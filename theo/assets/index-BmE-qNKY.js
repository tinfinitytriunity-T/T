...
`,rt=`https://youtu.be/y6HvOEovgG8?is=nLnkonWHWFcLZes6`,it=`https://www.youtube.com/embed/y6HvOEovgG8`,at=`/T/theo/images/irigaray/irigaray-divin-feminin-poster.png`,ot=[{title:`Repères principaux`,links:[[`Transcription`,`#transcription`],[`Analyse de la vidéo`,`#analyse-video`],[`Étude complète`,`#etude-complete`],[`Article polémique`,`#i-article-polemique-assume`],[`Recherches contradictoires`,`#ii-recherches-contradictoires-completes`],[`Trinitaire / féminin divin`,`#complement-trinitaire-feminin`],[`Contre-folie`,`#contre-folie`],[`Irigaray`,`#luce-irigaray`],[`Sources`,`#sources-et-references-a-integrer-sur-la-page`]]},{title:`Analyse de la vidéo`,links:[[`1. Centralité pastorale de l’affectivité`,`#2-2-theme-1-la-centralite-pastorale-de-l-affectivite`],[`2. Confession, répétition et culpabilité affective`,`#2-3-theme-2-confession-repetition-du-peche-et-culpabilite-affective`],[`3. Baiser sans relation construite`,`#2-4-theme-3-cas-numero-2-le-baiser-sans-relation-construite`],[`4. Geste comme promesse`,`#2-5-theme-4-le-geste-comme-promesse`],[`5. Relation amoureuse déjà construite`,`#2-6-theme-5-cas-numero-1-relation-amoureuse-deja-construite`],[`6. Geste efficace`,`#2-7-theme-6-le-geste-efficace`],[`7. Consentement, symétrie et communication`,`#2-8-theme-7-consentement-symetrie-et-communication`],[`8. Mariage, avenir durable et vérité du geste`,`#2-9-theme-8-mariage-avenir-durable-et-verite-du-geste`],[`9. Personne non baptisée et universalisation morale`,`#2-10-theme-9-personne-non-baptisee-et-universalisation-morale`],[`10. Objections : peur d’être quitté ou jugé`,`#2-11-theme-10-objections-peur-d-etre-quitte-peur-d-etre-juge`],[`11. Pression à être en couple`,`#2-12-theme-11-pression-a-etre-en-couple`],[`12. Champ clérical révélé`,`#2-13-theme-12-ce-que-la-conference-revele-du-champ-clerical`],[`13. Église laïque vs Église cléricale`,`#2-14-theme-13-eglise-laique-vs-eglise-clericale-a-partir-de-la-video`],[`14. Morale régulière, cléricale et séculiers`,`#2-15-theme-14-derive-plus-large-morale-reguliere-clericale-et-seculiers`],[`15. Approfondissements`,`#approfondissements`]]},{title:`Compléments et sources`,links:[[`Les délires des religieux`,`#les-delires-des-religieux`],[`Cantique des cantiques`,`#a-le-cantique-des-cantiques-un-texte-biblique-erotique-au-c-ur-du-canon`],[`Judaïsme rabbinique : onah`,`#b-judaisme-rabbinique-onah-devoir-conjugal-et-reconnaissance-du-desir-de-l-epouse`],[`Iggeret ha-Kodesh`,`#c-iggeret-ha-kodesh-l-union-sexuelle-comme-acte-saint`],[`Zohar et Shekhinah`,`#d-kabbale-et-zohar-erotique-cosmique-et-shekhinah-desirante`],[`Christianisme et Cantique`,`#f-christianisme-ancien-et-medieval-le-cantique-comme-matrice-mystique`],[`Vatican II et amour conjugal`,`#g-catholicisme-conciliaire-gaudium-et-spes-et-la-dignite-des-actes-conjugaux`],[`Théologie du corps`,`#i-jean-paul-ii-theologie-du-corps-nudite-sans-honte-et-signification-nuptiale`],[`Deus caritas est`,`#j-benoit-xvi-deus-caritas-est-et-la-non-separation-de-l-eros-et-de-l-agape`],[`Amoris laetitia`,`#k-francois-amoris-laetitia-et-la-dimension-erotique-de-l-amour`],[`Lecture T^ × Q^ × MCPP^ × MNL^`,`#iv-synthese-q-lecture-morphogenetique-du-champ`],[`Voix du féminin divin`,`#vii-feminin-divin-non-pas-ajout-decoratif-mais-correctif-structurel`],[`Sources bibliques`,`#sources-bibliques-et-juives`],[`Sources juives`,`#a-sources-bibliques-et-traditions-juives-du-nom`],[`Sources catholiques`,`#sources-catholiques-officielles`],[`Sources philosophiques`,`#d-foucault-pouvoir-folie-discipline-pastorat`],[`Sources féministes`,`#m-theologie-desir-feminin-divin`],[`Bibliographie complète`,`#bibliographie-classee-et-liens`]]}];function st(e){return e.toLowerCase().normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).replace(/[^a-z0-9]+/g,`-`).replace(/^-|-$/g,``)}function ct(e){return e.replace(/```[\s\S]*?```/g,``)}function lt(e){let t=e.replace(/\r\n/g,`
`).replace(/^---[\s\S]*?---\n/,``).split(`
`),n=[],r=0,i=!1,a=e=>/^(usage codex|note d[’']?intégration|note d[’']?integration|statut du complément|statut du complement|usage dans l[’']?article|consigne d[’']?intégration|consigne d[’']?integration|consignes codex|consignes de mise en page|tâches concrètes|taches concretes|note finale pour codex|titre court proposé|titre court propose|ancre suggérée|ancre suggeree|label de navigation)/i.test(e.trim()),o=e=>/(usage codex|note d[’']?intégration codex|note d[’']?integration codex|statut du complément|statut du complement|usage dans l[’']?article|formule possible|à utiliser pour|a utiliser pour|insérer ce complément|inserer ce complement|titre court proposé|titre court propose|ancre suggérée|ancre suggeree|label de navigation|instruction codex|destination suggérée|destination suggeree|intégration demandée|integration demandee|structure html recommandée|structure html recommandee|exemple html possible|^codex doit)/i.test(e);for(let e of t){let t=e.trim(),s=t.match(/^(#{1,6})\s+(.+)$/),c=s?.[1].length||0,l=s?.[2]?.trim()||``;if(r)if(s&&c<=r)r=0;else continue;if(s&&a(l)){r=c,i=!1;continue}if(s&&/ce qu[’']?il faut approfondir dans la page/i.test(l)){n.push(`${s[1]} Approfondissements`);continue}if(o(t)){i=/formule possible/i.test(t);continue}if(i){if(!t||t.startsWith(`>`))continue;i=!1}n.push(e)}return n.join(`
`).replace(/\n{3,}/g,`

`).trim()}function ut(e){let t=e.replace(/\r\n/g,`
`),n=t.indexOf(`# 2. Analyse de la vidéo`),r=t.indexOf(`# 28. Sources`),i=t.indexOf(`# 29. Consignes`),a=t.indexOf(`TRANSCRIPTION DE LA CONFÉRENCE`),o=a!==-1&&n!==-1?t.slice(a,n).replace(/<\/?details[^>]*>/g,``).replace(/<summary>[\s\S]*?<\/summary>/g,``).trim():``,s=n===-1?``:t.slice(n,r===-1?i===-1?void 0:i:r).trim(),c=r===-1?``:t.slice(r,i===-1?void 0:i).trim();return{transcript:lt(ct(o)),analysis:lt(ct(s)),sources:lt(ct(c))}}function dt(e){let t=e.replace(/\r\n/g,`
`),n=t.indexOf(`# I. Article polémique assumé`);return lt(ct(n===-1?t:t.slice(n).trim()))}function ft(e){let t=e.replace(/\r\n/g,`
`).replace(/^---[\s\S]*?---\n/,``),n=t.indexOf(`## 0. Fonction`),r=t.indexOf(`# XIV. Consignes Codex`);return lt(ct(t.slice(n===-1?0:n,r===-1?void 0:r).trim()))}function pt(e){let t=e.replace(/\r\n/g,`
`).replace(/^---[\s\S]*?---\n/,``).replace(/<\/?details[^>]*>/g,``).replace(/<summary>[\s\S]*?<\/summary>/g,``),n=t.indexOf(`# Encart`),r=t.indexOf(`## Note d`),i=t.indexOf(`# D`),a=t.indexOf(`# Conclusion courte`),o=t.slice(n===-1?0:n,r===-1?i:r).trim(),s=i===-1?``:t.slice(i,a===-1?void 0:a).trim(),c=a===-1?``:t.slice(a).trim();return{short:lt(ct(o)),development:lt(ct(s)),conclusion:lt(ct(c))}}function mt(e){let t=e.replace(/\r\n/g,`
`).replace(/^---[\s\S]*?---\n/,``),n=t.indexOf(`<summary><strong>Consignes Codex`);if(n!==-1){let e=t.slice(0,n).lastIndexOf(`<details>`);t=t.slice(0,e===-1?n:e)}t=t.replace(/<\/?details[^>]*>/g,``).replace(/<summary>[\s\S]*?<\/summary>/g,``);let r=t.indexOf(`# Compl`),i=t.indexOf(`# 1. Pourquoi`),a=t.slice(r===-1?0:r,i===-1?void 0:i).trim(),o=i===-1?``:t.slice(i).trim();return{short:lt(ct(a)),development:lt(ct(o))}}function ht(e,t){if(!t?.startsWith(`#`))return;let n=document.getElementById(t.slice(1));n&&(e.preventDefault(),n.scrollIntoView({behavior:`smooth`,block:`start`}))}function gt(e){let t=[],n=/(\*\*[^*]+\*\*|`[^`]+`|https?:\/\/[^\s)]+|\[[^\]]+\]\(https?:\/\/[^)]+\))/g,r=0,i;for(;(i=n.exec(e))!==null;){i.index>r&&t.push(e.slice(r,i.index));let a=i[0];if(a.startsWith(`**`))t.push((0,C.jsx)(`strong`,{children:a.slice(2,-2)},t.length));else if(a.startsWith("`"))t.push((0,C.jsx)(`code`,{children:a.slice(1,-1)},t.length));else if(a.startsWith(`[`)){let e=a.match(/^\[([^\]]+)\]\((https?:\/\/[^)]+)\)$/);t.push((0,C.jsx)(`a`,{href:e[2],target:`_blank`,rel:`noreferrer`,children:e[1]},t.length))}else t.push((0,C.jsx)(`a`,{href:a,target:`_blank`,rel:`noreferrer`,children:a},t.length));r=n.lastIndex}return r<e.length&&t.push(e.slice(r)),t}function _t(e,t){let n=e[t]?.trim(),r=e[t+1]?.trim();if(!n?.includes(`|`)||!/^\|?\s*:?-{3,}:?\s*(\|\s*:?-{3,}:?\s*)+\|?$/.test(r||``))return null;let i=e=>e.trim().replace(/^\|/,``).replace(/\|$/,``).split(`|`).map(e=>e.trim()),a=i(n),o=[],s=t+2;for(;s<e.length;){let t=e[s].trim();if(!t.includes(`|`)||!t)break;o.push(i(t)),s+=1}return{headers:a,rows:o,nextIndex:s}}function D({markdown:e,compact:t=!1}){let n=(0,_.useMemo)(()=>{let t=e.split(`
`),n=[],r=[],i=[],a=()=>{r.length&&(n.push({type:`p`,text:r.join(` `).trim()}),r=[])},o=()=>{i.length&&(n.push({type:`list`,items:i}),i=[])};for(let e=0;e<t.length;e+=1){let s=t[e].trim();if(!s||s===`---`||s===`***`){a(),o();continue}if(/^<.*>$/i.test(s)){a(),o();continue}let c=_t(t,e);if(c){a(),o(),n.push({type:`table`,headers:c.headers,rows:c.rows}),e=c.nextIndex-1;continue}let l=s.match(/^(#{1,4})\s+(.+)$/);if(l){a(),o(),n.push({type:`heading`,level:l[1].length,text:l[2].trim(),id:st(l[2])});continue}if(s.startsWith(`>`)){a(),o(),n.push({type:`quote`,text:s.replace(/^>\s?/,``).trim()});continue}let u=s.match(/^[-*]\s+(.+)$/);if(u){a(),i.push(u[1].trim());continue}r.push(s)}return a(),o(),n},[e]);return(0,C.jsx)(`div`,{className:t?`egliseMarkdown compact`:`egliseMarkdown`,children:n.map((e,t)=>e.type===`heading`?(0,C.jsx)(e.level<=1||e.level===2?`h2`:`h3`,{id:e.id,children:gt(e.text)},`${e.id}-${t}`):e.type===`quote`?(0,C.jsx)(`blockquote`,{children:gt(e.text)},t):e.type===`list`?(0,C.jsx)(`ul`,{children:e.items.map((e,n)=>(0,C.jsx)(`li`,{children:gt(e)},`${t}-${n}`))},t):e.type===`table`?(0,C.jsx)(`div`,{className:`comparison-table-wrap`,children:(0,C.jsxs)(`table`,{className:`comparison-table`,children:[(0,C.jsx)(`thead`,{children:(0,C.jsx)(`tr`,{children:e.headers.map((e,n)=>(0,C.jsx)(`th`,{children:gt(e)},`${t}-h-${n}`))})}),(0,C.jsx)(`tbody`,{children:e.rows.map((e,n)=>(0,C.jsx)(`tr`,{children:e.map((e,r)=>(0,C.jsx)(`td`,{children:gt(e)},`${t}-r-${n}-c-${r}`))},`${t}-r-${n}`))})]})},t):(0,C.jsx)(`p`,{children:gt(e.text)},t))})}function vt({navigate:e}){let t=(0,_.useMemo)(()=>ut(Qe),[]),n=(0,_.useMemo)(()=>dt($e),[]),r=(0,_.useMemo)(()=>ft(et),[]),i=(0,_.useMemo)(()=>pt(tt),[]),a=(0,_.useMemo)(()=>mt(nt),[]);return(0,_.useEffect)(()=>{let e=window.location.hash.split(`#`).slice(2).join(`#`);e&&window.setTimeout(()=>{document.getElementById(e)?.scrollIntoView({block:`start`})},250)},[]),(0,C.jsxs)(`section`,{className:`w-full overflow-x-hidden px-4 py-6 text-slate-100 sm:px-6 lg:px-10`,children:[(0,C.jsxs)(`div`,{className:`mx-auto flex w-full max-w-7xl flex-col gap-7`,children:[(0,C.jsx)(`button`,{type:`button`,onClick:()=>e(`explorations`),className:`w-fit rounded-full border border-sky-200/14 bg-slate-950/50 px-4 py-2 text-sm font-bold text-slate-200 transition hover:border-cyan-100/28`,children:`Retour aux explorations`}),(0,C.jsxs)(`header`,{className:`egliseHero`,children:[(0,C.jsx)(`div`,{className:`egliseVideoFrame`,children:(0,C.jsx)(`iframe`,{src:it,title:`Vidéo source — Église laïque vs Église cléricale`,loading:`lazy`,allow:`accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share`,allowFullScreen:!0})}),(0,C.jsxs)(`div`,{className:`egliseHeroCopy`,children:[(0,C.jsx)(`p`,{className:`egliseEyebrow`,children:`Exploration ecclésiologique`}),(0,C.jsx)(`h1`,{children:`Église laïque vs Église cléricale`}),(0,C.jsx)(`p`,{children:`À partir d’une conférence sur la vie affective, le baiser et les relations, cette page analyse la tension entre peuple baptismal, parole cléricale, morale du corps, couples séculiers, conscience et dérives institutionnelles.`}),(0,C.jsx)(`div`,{className:`egliseBadges`,children:[`Église`,`Laïcat`,`Cléricalisme`,`Affectivité`,`T^ / MNL^ / MCPP^`].map(e=>(0,C.jsx)(`span`,{children:e},e))}),(0,C.jsxs)(`div`,{className:`egliseActions`,children:[(0,C.jsx)(`a`,{href:rt,target:`_blank`,rel:`noreferrer`,children:`Voir sur YouTube`}),(0,C.jsx)(`a`,{href:`#transcription`,onClick:e=>ht(e,`#transcription`),children:`Transcription`}),(0,C.jsx)(`a`,{href:`#analyse-video`,onClick:e=>ht(e,`#analyse-video`),children:`Analyse vidéo`}),(0,C.jsx)(`a`,{href:`#etude-complete`,onClick:e=>ht(e,`#etude-complete`),children:`Étude complète`}),(0,C.jsx)(`a`,{href:`#complement-contretraditions`,onClick:e=>ht(e,`#complement-contretraditions`),children:`Complément`}),(0,C.jsx)(`a`,{href:`#complement-trinitaire-feminin`,onClick:e=>ht(e,`#complement-trinitaire-feminin`),children:`Complément trinitaire`}),(0,C.jsx)(`a`,{href:`#contre-folie`,onClick:e=>ht(e,`#contre-folie`),children:`Contre-folie`}),(0,C.jsx)(`a`,{href:`#luce-irigaray`,onClick:e=>ht(e,`#luce-irigaray`),children:`Irigaray`})]})]})]}),(0,C.jsxs)(`aside`,{className:`egliseStatus`,children:[(0,C.jsx)(`b`,{children:`Statut de la page`}),(0,C.jsx)(`p`,{children:`Cette exploration distingue la vidéo source, la transcription accessible, l’analyse thématique de la conférence et l’étude ecclésiologique élargie. Le propos n’est pas traité comme attaque personnelle contre le conférencier, mais comme symptôme local d’un champ historique et institutionnel plus vaste.`})]}),(0,C.jsxs)(`nav`,{className:`egliseToc article-toc toc-columns`,"aria-label":`Sommaire de la page`,children:[(0,C.jsxs)(`div`,{className:`toc-header`,children:[(0,C.jsx)(`span`,{children:`Sommaire de la page`}),(0,C.jsx)(`span`,{className:`toc-hint`,children:`Tous les repères sont cliquables`})]}),(0,C.jsx)(`div`,{className:`toc-columns-grid`,children:ot.map(e=>(0,C.jsxs)(`div`,{className:`toc-column`,children:[(0,C.jsx)(`h3`,{children:e.title}),e.links.map(([e,t])=>(0,C.jsx)(`a`,{href:t,onClick:e=>ht(e,t),children:e},t))]},e.title))})]}),(0,C.jsxs)(`section`,{id:`transcription`,className:`eglisePanel`,children:[(0,C.jsx)(`p`,{className:`egliseEyebrow`,children:`Texte accessible`}),(0,C.jsx)(`h2`,{children:`Transcription texte accessible`}),(0,C.jsx)(`p`,{className:`egliseIntro`,children:`Cette transcription permet de rendre le contenu de la vidéo consultable sans lecteur vidéo, accessible aux lecteurs d’écran et exploitable pour la lecture, la recherche et l’étude.`}),(0,C.jsxs)(`details`,{children:[(0,C.jsx)(`summary`,{children:`Afficher / masquer la transcription complète`}),(0,C.jsx)(D,{markdown:t.transcript,compact:!0})]})]}),(0,C.jsxs)(`article`,{id:`analyse-video`,className:`eglisePanel`,children:[(0,C.jsx)(`span`,{id:`etude-complete`,className:`scrollAnchor`,"aria-hidden":`true`}),(0,C.jsx)(D,{markdown:t.analysis})]}),(0,C.jsxs)(`article`,{id:`complement-contretraditions`,className:`eglisePanel egliseComplement`,children:[(0,C.jsx)(`p`,{className:`egliseEyebrow`,children:`Complément polémique et recherches contradictoires`}),(0,C.jsx)(`h2`,{children:`Les délires des religieux / Contre-traditions théologiques du corps`}),(0,C.jsx)(`aside`,{className:`egliseEditorialNote`,children:`Ce texte critique des formes de discours religieux et clérical. Il ne vise pas les personnes consacrées en tant que telles, ni la vie religieuse comme vocation. Il analyse des dérives de langage, de pouvoir, de compétence et d’emprise symbolique.`}),(0,C.jsx)(D,{markdown:n})]}),(0,C.jsxs)(`article`,{id:`complement-trinitaire-feminin`,className:`eglisePanel egliseComplement egliseTrinitarian`,children:[(0,C.jsx)(`p`,{className:`egliseEyebrow`,children:`Complément III · T^ × Q^ × MCPP^ × MNL^`}),(0,C.jsx)(`h2`,{children:`Lecture trinitaire, féminin divin et morphogénétique du désir`}),(0,C.jsx)(`aside`,{className:`egliseEditorialNote`,children:`Cette troisième partie déplace la critique vers une exploration théologique plus profonde : Trinité, relation, féminin divin, corps, désir, parole, lumière, nuit, matière et champ morphogénétique.`}),(0,C.jsx)(D,{markdown:r})]}),(0,C.jsxs)(`article`,{id:`contre-folie`,className:`eglisePanel egliseComplement egliseCounterMadness`,children:[(0,C.jsx)(`p`,{className:`egliseEyebrow`,children:`Encart spécial`}),(0,C.jsx)(D,{markdown:i.short}),(0,C.jsxs)(`details`,{children:[(0,C.jsx)(`summary`,{children:`Lire l'analyse complète et les références`}),(0,C.jsx)(D,{markdown:i.development}),(0,C.jsx)(D,{markdown:i.conclusion})]})]}),(0,C.jsxs)(`article`,{id:`luce-irigaray`,className:`eglisePanel egliseComplement egliseIrigaray`,children:[(0,C.jsx)(`span`,{id:`irigaray-feminin-nom-capture`,className:`scrollAnchor`,"aria-hidden":`true`}),(0,C.jsx)(`p`,{className:`egliseEyebrow`,children:`Complément V · Luce Irigaray`}),(0,C.jsx)(D,{markdown:a.short}),(0,C.jsxs)(`figure`,{className:`articleHeroFigure irigarayFigure`,children:[(0,C.jsx)(`a`,{href:at,target:`_blank`,rel:`noreferrer`,"aria-label":`Ouvrir l'affiche Luce Irigaray en haute définition`,children:(0,C.jsx)(`img`,{src:at,alt:`Affiche conceptuelle Luce Irigaray, féminin divin et contre-capture`,loading:`lazy`})}),(0,C.jsx)(`figcaption`,{children:`Luce Irigaray — féminin divin, corps, parole, différence et critique de la capture masculine du divin.`})]}),(0,C.jsxs)(`details`,{children:[(0,C.jsx)(`summary`,{children:`Lire l'analyse complète et les sources`}),(0,C.jsx)(D,{markdown:a.development})]})]}),(0,C.jsx)(`article`,{id:`sources-et-references-a-integrer-sur-la-page`,className:`eglisePanel`,children:(0,C.jsx)(D,{markdown:t.sources})})]}),(0,C.jsx)(`style`,{children:`
        .egliseHero {
          display: grid;
        ...
        .egliseActions a { padding: 0.62rem 0.9rem; }
        .egliseActions a:hover { border-color: rgba(216, 182, 106, 0.42); color: #fff3c4; }
        .egliseStatus,
        .eglisePanel {
        ...
        .article-toc.toc-columns {
          max-width: 1180px;
          margin: 0 auto;
          padding: 1.15rem;
          border: 1px solid rgba(245, 232, 197, 0.14);
          border-radius: 24px;
          background:
            radial-gradient(circle at 50% 0%, rgba(231, 196, 116, 0.10), transparent 42%),
            rgba(8, 10, 18, 0.62);
        }
        .toc-header {
          display: flex;
          ...
          border-bottom: 1px solid rgba(245, 232, 197, 0.10);
        }
        .toc-header span:first-child {
          color: rgba(245, 232, 197, 0.96);
          font-weight: 800;
        ...
        .toc-column { min-width: 0; }
        .toc-column h3 {
          margin: 0 0 0.55rem;
          color: rgba(231, 196, 116, 0.92);
          font-size: 0.88rem;
          font-weight: 800;
          letter-spacing: 0.02em;
        }
        .toc-column a {
          ...
          font-size: 0.86rem;
          line-height: 1.35;
          border-bottom: 1px solid rgba(245, 232, 197, 0.055);
          overflow-wrap: anywhere;
        }
        .toc-column a:hover,
        .toc-column a:focus-visible {
          color: #f5e8c5;
        ...
        .comparison-table th {
          color: rgba(231, 196, 116, 0.95);
          font-weight: 700;
          background: rgba(231, 196, 116, 0.06);
        }
        .comparison-table td {
          color: rgba(245, 232, 197, 0.82);
        }
...
`;(0,v.createRoot)(document.getElementById(`root`)).render((0,C.jsx)(_.StrictMode,{children:(0,C.jsx)(xr,{})}));