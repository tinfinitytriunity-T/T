...
C’est l’un des aspects les plus justes de la conférence : la symétrie affective et le respect des seuils. Un geste ne doit pas mettre l’autre mal à l’aise. Un geste ne doit pas être imposé. Un geste peut être trop excitant pour l’un et banal pour l’autre. Il faut pouvoir le dire.
...
`,nt=`https://youtu.be/y6HvOEovgG8?is=nLnkonWHWFcLZes6`,rt=`https://www.youtube.com/embed/y6HvOEovgG8`;function it(e){return e.toLowerCase().normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).replace(/[^a-z0-9]+/g,`-`).replace(/^-|-$/g,``)}function at(e){return e.replace(/```[\s\S]*?```/g,``)}function ot(e){let t=e.replace(/\r\n/g,`
`),n=t.indexOf(`# 2. Analyse de la vidéo`),r=t.indexOf(`# 28. Sources`),i=t.indexOf(`# 29. Consignes`),a=t.indexOf(`TRANSCRIPTION DE LA CONFÉRENCE`),o=a!==-1&&n!==-1?t.slice(a,n).replace(/<\/?details[^>]*>/g,``).replace(/<summary>[\s\S]*?<\/summary>/g,``).trim():``,s=n===-1?``:t.slice(n,r===-1?i===-1?void 0:i:r).trim(),c=r===-1?``:t.slice(r,i===-1?void 0:i).trim();return{transcript:at(o),analysis:at(s),sources:at(c)}}function st(e){let t=e.replace(/\r\n/g,`
`),n=t.indexOf(`# I. Article polémique assumé`);return at(n===-1?t:t.slice(n).trim())}function ct(e){let t=e.replace(/\r\n/g,`
`).replace(/^---[\s\S]*?---\n/,``),n=t.indexOf(`## 0. Fonction`),r=t.indexOf(`# XIV. Consignes Codex`);return at(t.slice(n===-1?0:n,r===-1?void 0:r).trim())}function lt(e){let t=e.replace(/\r\n/g,`
`).replace(/^---[\s\S]*?---\n/,``).replace(/<\/?details[^>]*>/g,``).replace(/<summary>[\s\S]*?<\/summary>/g,``),n=t.indexOf(`# Encart`),r=t.indexOf(`## Note d`),i=t.indexOf(`# D`),a=t.indexOf(`# Conclusion courte`),o=t.slice(n===-1?0:n,r===-1?i:r).trim(),s=i===-1?``:t.slice(i,a===-1?void 0:a).trim(),c=a===-1?``:t.slice(a).trim();return{short:at(o),development:at(s),conclusion:at(c)}}function ut(e){let t=e.replace(/\r\n/g,`
`).replace(/^---[\s\S]*?---\n/,``),n=t.indexOf(`<summary><strong>Consignes Codex`);if(n!==-1){let e=t.slice(0,n).lastIndexOf(`<details>`);t=t.slice(0,e===-1?n:e)}t=t.replace(/<\/?details[^>]*>/g,``).replace(/<summary>[\s\S]*?<\/summary>/g,``);let r=t.indexOf(`# Compl`),i=t.indexOf(`# 1. Pourquoi`),a=t.slice(r===-1?0:r,i===-1?void 0:i).trim(),o=i===-1?``:t.slice(i).trim();return{short:at(a),development:at(o)}}function dt(e){return e.split(`
`).map(e=>e.match(/^(#{1,3})\s+(.+)$/)).filter(Boolean).map(e=>({level:e[1].length,title:e[2].trim(),id:it(e[2])}))}function ft(e){let t=[],n=/(\*\*[^*]+\*\*|`[^`]+`|https?:\/\/[^\s)]+|\[[^\]]+\]\(https?:\/\/[^)]+\))/g,r=0,i;for(;(i=n.exec(e))!==null;){i.index>r&&t.push(e.slice(r,i.index));let a=i[0];if(a.startsWith(`**`))t.push((0,C.jsx)(`strong`,{children:a.slice(2,-2)},t.length));else if(a.startsWith("`"))t.push((0,C.jsx)(`code`,{children:a.slice(1,-1)},t.length));else if(a.startsWith(`[`)){let e=a.match(/^\[([^\]]+)\]\((https?:\/\/[^)]+)\)$/);t.push((0,C.jsx)(`a`,{href:e[2],target:`_blank`,rel:`noreferrer`,children:e[1]},t.length))}else t.push((0,C.jsx)(`a`,{href:a,target:`_blank`,rel:`noreferrer`,children:a},t.length));r=n.lastIndex}return r<e.length&&t.push(e.slice(r)),t}function pt({markdown:e,compact:t=!1}){let n=(0,_.useMemo)(()=>{let t=e.split(`
`),n=[],r=[],i=[],a=()=>{r.length&&(n.push({type:`p`,text:r.join(` `).trim()}),r=[])},o=()=>{i.length&&(n.push({type:`list`,items:i}),i=[])};return t.forEach(e=>{let t=e.trim();if(!t||t===`---`||t===`***`){a(),o();return}let s=t.match(/^(#{1,4})\s+(.+)$/);if(s){a(),o(),n.push({type:`heading`,level:s[1].length,text:s[2].trim(),id:it(s[2])});return}if(t.startsWith(`>`)){a(),o(),n.push({type:`quote`,text:t.replace(/^>\s?/,``).trim()});return}let c=t.match(/^[-*]\s+(.+)$/);if(c){a(),i.push(c[1].trim());return}r.push(t)}),a(),o(),n},[e]);return(0,C.jsx)(`div`,{className:t?`egliseMarkdown compact`:`egliseMarkdown`,children:n.map((e,t)=>e.type===`heading`?(0,C.jsx)(e.level<=1||e.level===2?`h2`:`h3`,{id:e.id,children:ft(e.text)},`${e.id}-${t}`):e.type===`quote`?(0,C.jsx)(`blockquote`,{children:ft(e.text)},t):e.type===`list`?(0,C.jsx)(`ul`,{children:e.items.map((e,n)=>(0,C.jsx)(`li`,{children:ft(e)},`${t}-${n}`))},t):(0,C.jsx)(`p`,{children:ft(e.text)},t))})}function mt({navigate:e}){let t=(0,_.useMemo)(()=>ot(Ze),[]),n=(0,_.useMemo)(()=>st(Qe),[]),r=(0,_.useMemo)(()=>ct($e),[]),i=(0,_.useMemo)(()=>lt(et),[]),a=(0,_.useMemo)(()=>ut(tt),[]),o=(0,_.useMemo)(()=>dt(t.analysis).filter(e=>e.level<=2).slice(0,28),[t.analysis]),s=(0,_.useMemo)(()=>dt(n).filter(e=>e.level<=1).slice(0,8),[n]),c=(0,_.useMemo)(()=>dt(r).filter(e=>e.level<=1).slice(0,8),[r]),l=(0,_.useMemo)(()=>dt(i.development).filter(e=>e.level<=2).slice(0,8),[i.development]),u=(0,_.useMemo)(()=>dt(a.development).filter(e=>e.level<=2).slice(0,8),[a.development]);return(0,C.jsxs)(`section`,{className:`w-full overflow-x-hidden px-4 py-6 text-slate-100 sm:px-6 lg:px-10`,children:[(0,C.jsxs)(`div`,{className:`mx-auto flex w-full max-w-7xl flex-col gap-7`,children:[(0,C.jsx)(`button`,{type:`button`,onClick:()=>e(`explorations`),className:`w-fit rounded-full border border-sky-200/14 bg-slate-950/50 px-4 py-2 text-sm font-bold text-slate-200 transition hover:border-cyan-100/28`,children:`Retour aux explorations`}),(0,C.jsxs)(`header`,{className:`egliseHero`,children:[(0,C.jsx)(`div`,{className:`egliseVideoFrame`,children:(0,C.jsx)(`iframe`,{src:rt,title:`Vidéo source — Église laïque vs Église cléricale`,loading:`lazy`,allow:`accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share`,allowFullScreen:!0})}),(0,C.jsxs)(`div`,{className:`egliseHeroCopy`,children:[(0,C.jsx)(`p`,{className:`egliseEyebrow`,children:`Exploration ecclésiologique`}),(0,C.jsx)(`h1`,{children:`Église laïque vs Église cléricale`}),(0,C.jsx)(`p`,{children:`À partir d’une conférence sur la vie affective, le baiser et les relations, cette page analyse la tension entre peuple baptismal, parole cléricale, morale du corps, couples séculiers, conscience et dérives institutionnelles.`}),(0,C.jsx)(`div`,{className:`egliseBadges`,children:[`Église`,`Laïcat`,`Cléricalisme`,`Affectivité`,`T^ / MNL^ / MCPP^`].map(e=>(0,C.jsx)(`span`,{children:e},e))}),(0,C.jsxs)(`div`,{className:`egliseActions`,children:[(0,C.jsx)(`a`,{href:nt,target:`_blank`,rel:`noreferrer`,children:`Voir sur YouTube`}),(0,C.jsx)(`a`,{href:`#transcription`,children:`Transcription`}),(0,C.jsx)(`a`,{href:`#analyse-video`,children:`Analyse vidéo`}),(0,C.jsx)(`a`,{href:`#etude-complete`,children:`Étude complète`}),(0,C.jsx)(`a`,{href:`#complement-contretraditions`,children:`Complément`}),(0,C.jsx)(`a`,{href:`#complement-trinitaire-feminin`,children:`Complément trinitaire`}),(0,C.jsx)(`a`,{href:`#contre-folie`,children:`Contre-folie`}),(0,C.jsx)(`a`,{href:`#irigaray-feminin-nom-capture`,children:`Irigaray`})]})]})]}),(0,C.jsxs)(`aside`,{className:`egliseStatus`,children:[(0,C.jsx)(`b`,{children:`Statut de la page`}),(0,C.jsx)(`p`,{children:`Cette exploration distingue la vidéo source, la transcription accessible, l’analyse thématique de la conférence et l’étude ecclésiologique élargie. Le propos n’est pas traité comme attaque personnelle contre le conférencier, mais comme symptôme local d’un champ historique et institutionnel plus vaste.`})]}),(0,C.jsxs)(`nav`,{className:`egliseToc`,"aria-label":`Sommaire de l'exploration`,children:[(0,C.jsx)(`a`,{href:`#transcription`,children:`Transcription`}),(0,C.jsx)(`a`,{href:`#analyse-video`,children:`Analyse de la vidéo`}),(0,C.jsx)(`a`,{href:`#etude-complete`,children:`Étude complète`}),(0,C.jsx)(`a`,{href:`#complement-contretraditions`,children:`Complément polémique et recherches contradictoires`}),(0,C.jsx)(`a`,{href:`#complement-trinitaire-feminin`,children:`Complément trinitaire / féminin divin`}),(0,C.jsx)(`a`,{href:`#contre-folie`,children:`Contre-folie`}),(0,C.jsx)(`a`,{href:`#irigaray-feminin-nom-capture`,children:`Irigaray — Féminin, Nom et capture`}),(0,C.jsx)(`a`,{href:`#sources-et-references-a-integrer-sur-la-page`,children:`Sources`}),o.slice(0,16).map(e=>(0,C.jsx)(`a`,{href:`#${e.id}`,children:e.title.replace(/^\d+\.\s*/,``)},e.id)),s.map(e=>(0,C.jsx)(`a`,{href:`#${e.id}`,children:e.title.replace(/^I+V?X?\.\s*/,``)},e.id)),c.map(e=>(0,C.jsx)(`a`,{href:`#${e.id}`,children:e.title.replace(/^I+V?X?\.\s*/,``)},e.id)),l.map(e=>(0,C.jsx)(`a`,{href:`#${e.id}`,children:e.title.replace(/^\d+\.\s*/,``)},e.id)),u.map(e=>(0,C.jsx)(`a`,{href:`#${e.id}`,children:e.title.replace(/^\d+\.\s*/,``)},e.id))]}),(0,C.jsxs)(`section`,{id:`transcription`,className:`eglisePanel`,children:[(0,C.jsx)(`p`,{className:`egliseEyebrow`,children:`Texte accessible`}),(0,C.jsx)(`h2`,{children:`Transcription texte accessible`}),(0,C.jsx)(`p`,{className:`egliseIntro`,children:`Cette transcription permet de rendre le contenu de la vidéo consultable sans lecteur vidéo, accessible aux lecteurs d’écran et exploitable pour la lecture, la recherche et l’étude.`}),(0,C.jsxs)(`details`,{children:[(0,C.jsx)(`summary`,{children:`Afficher / masquer la transcription complète`}),(0,C.jsx)(pt,{markdown:t.transcript,compact:!0})]})]}),(0,C.jsxs)(`article`,{id:`analyse-video`,className:`eglisePanel`,children:[(0,C.jsx)(`span`,{id:`etude-complete`,className:`scrollAnchor`,"aria-hidden":`true`}),(0,C.jsx)(pt,{markdown:t.analysis})]}),(0,C.jsxs)(`article`,{id:`complement-contretraditions`,className:`eglisePanel egliseComplement`,children:[(0,C.jsx)(`p`,{className:`egliseEyebrow`,children:`Complément polémique et recherches contradictoires`}),(0,C.jsx)(`h2`,{children:`Les délires des religieux / Contre-traditions théologiques du corps`}),(0,C.jsx)(`aside`,{className:`egliseEditorialNote`,children:`Ce texte critique des formes de discours religieux et clérical. Il ne vise pas les personnes consacrées en tant que telles, ni la vie religieuse comme vocation. Il analyse des dérives de langage, de pouvoir, de compétence et d’emprise symbolique.`}),(0,C.jsx)(pt,{markdown:n})]}),(0,C.jsxs)(`article`,{id:`complement-trinitaire-feminin`,className:`eglisePanel egliseComplement egliseTrinitarian`,children:[(0,C.jsx)(`p`,{className:`egliseEyebrow`,children:`Complément III · T^ × Q^ × MCPP^ × MNL^`}),(0,C.jsx)(`h2`,{children:`Lecture trinitaire, féminin divin et morphogénétique du désir`}),(0,C.jsx)(`aside`,{className:`egliseEditorialNote`,children:`Cette troisième partie déplace la critique vers une exploration théologique plus profonde : Trinité, relation, féminin divin, corps, désir, parole, lumière, nuit, matière et champ morphogénétique.`}),(0,C.jsx)(pt,{markdown:r})]}),(0,C.jsxs)(`article`,{id:`contre-folie`,className:`eglisePanel egliseComplement egliseCounterMadness`,children:[(0,C.jsx)(`p`,{className:`egliseEyebrow`,children:`Encart spécial`}),(0,C.jsx)(pt,{markdown:i.short}),(0,C.jsxs)(`details`,{children:[(0,C.jsx)(`summary`,{children:`Lire l'analyse complète et les références`}),(0,C.jsx)(pt,{markdown:i.development}),(0,C.jsx)(pt,{markdown:i.conclusion})]})]}),(0,C.jsxs)(`article`,{id:`irigaray-feminin-nom-capture`,className:`eglisePanel egliseComplement egliseIrigaray`,children:[(0,C.jsx)(`p`,{className:`egliseEyebrow`,children:`Complément V · Luce Irigaray`}),(0,C.jsx)(pt,{markdown:a.short}),(0,C.jsxs)(`details`,{children:[(0,C.jsx)(`summary`,{children:`Lire l'analyse complète et les sources`}),(0,C.jsx)(pt,{markdown:a.development})]})]}),(0,C.jsx)(`article`,{id:`sources-et-references-a-integrer-sur-la-page`,className:`eglisePanel`,children:(0,C.jsx)(pt,{markdown:t.sources})})]}),(0,C.jsx)(`style`,{children:`
        .egliseHero {
          display: grid;
...
`;(0,v.createRoot)(document.getElementById(`root`)).render((0,C.jsx)(_.StrictMode,{children:(0,C.jsx)(_r,{})}));